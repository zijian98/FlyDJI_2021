...
public class TrackingActivity extends CameraOnly implements TextureView.SurfaceTextureListener,
        View.OnClickListener, View.OnTouchListener,
        CompoundButton.OnCheckedChangeListener, ActiveTrackMissionOperatorListener {
    ...
    private void updateMultiTrackingView(final SubjectSensingState[] targetSensingInformations) {
        ...
        for (SubjectSensingState target : targetSensingInformations) {
            ...
            if (targetViewHashMap.containsKey(target.getIndex())) {
                ...
                MultiTrackingView trackingView = new MultiTrackingView(TrackingActivity.this);
