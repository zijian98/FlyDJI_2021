...
public class CameraActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    ...
    private Button mCaptureBtn, mShootPhotoModeBtn, mRecordVideoModeBtn, mTakeoff, mLand;
    private ToggleButton mRecordBtn;
    private TextView recordingTime, resolution;

    private Handler handler;
    private Spinner modeSpin;
    String[] mode = new String[] {"SINGLE", "INTERVAL", "BURST"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Camera camera = FlyDJI.getCameraInstance();
        ...
        if (camera != null) {
            ...
            camera.getVideoResolutionAndFrameRate(new CommonCallbacks.CompletionCallbackWith<ResolutionAndFrameRate>() {
                ...
                public void onSuccess(ResolutionAndFrameRate resolutionAndFrameRate) {
                    resolution.setText("Resolution: " + resolutionAndFrameRate.getResolution() + "\n" +
    ...
    private void initUI() {
        ...
        resolution = (TextView) findViewById(R.id.param);
        mCaptureBtn = (Button) findViewById(R.id.btn_capture);
        mRecordBtn = (ToggleButton) findViewById(R.id.btn_record);
        mShootPhotoModeBtn = (Button) findViewById(R.id.btn_shoot_photo_mode);
        mRecordVideoModeBtn = (Button) findViewById(R.id.btn_record_video_mode);
        mTakeoff = findViewById(R.id.btn_fly);
        mLand = findViewById(R.id.btn_land);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_fly:{
                FlightController flightController = FlyDJI.getAircraftInstance().getFlightController();
                flightController.startTakeoff(new CommonCallbacks.CompletionCallback() {
                    ...
                    public void onResult(DJIError djiError) {
                        ...
                        } else showToast(djiError.getDescription());
                    }
                });
            }
            case R.id.btn_land:{
    ...
    private void captureAction(){
        ...
        final Camera camera = FlyDJI.getCameraInstance();
        if (camera != null) {
