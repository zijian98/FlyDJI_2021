...
public class CameraOnly extends FragmentActivity implements TextureView.SurfaceTextureListener {
    ...
    private void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(CameraOnly.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initPreviewer() {
        try {
            mProduct = FlyDJI.getProductInstance();
    ...
    private void updateTitleBar() {
        ...
        if (product != null) {
            if(product.isConnected()) {
                mConnectStatusTextView.setText(FlyDJI.getProductInstance().getModel().getDisplayName() + " Connected");
                ret = true;
            } else {
